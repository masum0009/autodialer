...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'fullname' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'profileimage' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'call_forwarding_to' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'active' => ['type' => 'tinyinteger', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'call_forwarding_to' => 'Lorem ipsum dolor sit amet',
                'active' => 1,
                'created' => '2021-09-21 09:55:51',
                'modified' => '2021-09-21 09:55:51',
            ],
        ];
        parent::init();
    }
