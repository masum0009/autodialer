        ...
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    ...
                    <div class="card-header"><strong style="font-size: 22px">Edit Campaign</strong>
                        <div class="float-right">
                            <ol class="text-right">

                                <button class="btn btn-primary btn-sm ml-2 pull-right px-2" id="button" type="submit"
                                        value="add"
                                ...
                                <button class="btn btn-primary btn-sm ml-2 pull-right px-2" id="button" type="submit"
                                    ...
                                    <i class="fa fa-list"></i> Campaign List
                                </button>
                    ...
                    <div class="card-body card-block ">
                        <?php echo $this->Form->create($campaign, array('role' => 'form', 'id'=> 'campaign-form', 'type' => 'file')); ?>
                                ...
                                <div class="form-row mt-2 col-md-12 clearfix">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="form-group mt-3">
                                            <?php echo $this->Form->input('contact_groups', array('label' => 'Please select contact group', 'required' => true,  'disabled' =>   $campaign->status ? true : false,  'class' => 'form-control', 'options' => $contactGroups, 'multiple' => true)); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <!--<div class="form-group mt-1">
                                            ...
                                            <label for="setup_ivr">Need to setup IVR  </label>
                                        </div> -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="form-row mt-2 col-md-12 clearfix">
                                    <div class="col-md-12 mb-6">
                                        ...
                                        <div class="weekDays-selector">
                                            <?php $days = explode(',', $campaign->weekdays); ?>
                                            <?php echo $this->Form->checkbox('weekdays.Mon', array('id' => "weekday-mon", 'class' => 'weekday','default'=> in_array('Mon', $days) ? '1' : '0'  )); ?>
                                            <label for="weekday-mon">Mo</label>
                                            <?php echo $this->Form->checkbox('weekdays.Tue', array('id' => "weekday-tue", 'class' => 'weekday','default'=>in_array('Tue', $days) ? '1' : '0')); ?>
                                            <label for="weekday-tue">Tu</label>
                                            <?php echo $this->Form->checkbox('weekdays.Wed', array('id' => "weekday-wed", 'class' => 'weekday','default'=>in_array('Wed', $days) ? '1' : '0')); ?>
                                            <label for="weekday-wed">We</label>
                                            <?php echo $this->Form->checkbox('weekdays.Thu', array('id' => "weekday-thu", 'class' => 'weekday','default'=>in_array('Thu', $days) ? '1' : '0')); ?>
                                            <label for="weekday-thu">Th</label>
                                            <?php echo $this->Form->checkbox('weekdays.Fri', array('id' => "weekday-fri", 'class' => 'weekday','default'=>in_array('Fri', $days) ? '1' : '0')); ?>
                                            <label for="weekday-fri">Fr</label>
                                            <?php echo $this->Form->checkbox('weekdays.Sat', array('id' => "weekday-sat", 'class' => 'weekday','default'=>in_array('Sat', $days) ? '1' : '0')); ?>
                                            <label for="weekday-sat">Sa</label>
                                            <?php echo $this->Form->checkbox('weekdays.Sun', array('id' => "weekday-sun", 'class' => 'weekday','default'=>in_array('Sun', $days) ? '1' : '0')); ?>
                                ...
                                <div class="form-row mt-2 col-md-12 clearfix">
                                    <div class="col-md-6 mb-3">                                        
                                        <?php echo $this->Form->input('start_at', array( 'value' => date('Y-m-d',strtotime($campaign->start_at) ),'type' => 'text', 'class' => 'form-control', 'placeholder' => 'Start At')); ?>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        
                                        <?php echo $this->Form->input('finished_at', array( 'value' => date('Y-m-d',strtotime($campaign->finished_at) ), 'type' => 'text', 'class' => 'form-control', 'placeholder' => 'Finished At')); ?>
                                    </div>
                                </div>
                                <div class="form-row mt-2 col-md-12 clearfix">
                                    <div class="col-md-6 mb-3">
                                        
                                        <?php echo $this->Form->input('daily_start_time', array('type' => 'text', 'value' => date('H:i:s',strtotime($campaign->daily_start_time) ), 'class' => 'form-control', 'placeholder' => 'Daily Start Time')); ?>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        
                                        <?php echo $this->Form->input('daily_stop_time', array( 'type' => 'text', 'value' => date('H:i:s',strtotime($campaign->daily_stop_time) ), 'class' => 'form-control', 'placeholder' => 'Daily Stop Time')); ?>
...
<script>
  $(document).ready(function(){
    ...
    if($("#pbx-gateway-id").val() != ''){
        $("#connect-pbx").attr("checked", true);
        // $("#connect-pbx").trigger("click");
        handlePBX();
    }
    ...
    function handlePBX(){
        if( $("#connect-pbx").prop('checked') == true){
            ...
            $("#file-name").attr('required', true);
        }
    }

    $(".date select, .time select").each((index, item) => {
        console.log($(item).addClass("form-control"));
    })
