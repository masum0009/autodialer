...
class="card-header"><strong style="font-size: 22px;">Add Gateway</strong>
...
fa-list"></i> Gateways </button> </ol> </div> </div> <div
...
['controller' => 'Gateway', 'action' => 'add']) ?>
                        ...
                        <div class="form-row mt-2 col-md-12 clearfix">
                            <div class="col-md-12 mb-3">
                                <?= $this->Form->input('password', array('label' => 'Password', 'class' => 'form-control', 'required' => true, 'placeholder' => 'Password')); ?>
                            </div>
                        </div>
                        <div class="form-row mt-2 col-md-12 clearfix">
                            <div class="col-md-12 mb-3">
