        ...
        <div class="header-menu">
            ...
            <div class="user-area dropdown float-right">
                ...
                <div class="user-menu dropdown-menu">
                    <?php echo $this->Html->link(__('<i class="fa fa-user-o"></i>'.'Profile'), array('controller' => 'client', 'action' => 'edit'), array('class'=>'nav-link','escape' => false)); ?>
                    <?php // echo $this->Html->link(__('<i class="fa fa-edit"></i>'.'Update profile'), array('controller' => 'clients', 'action' => 'update'), array('class'=>'nav-link','escape' => false)); ?>
