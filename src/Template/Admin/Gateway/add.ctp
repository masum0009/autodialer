...
['controller' => 'Gateway', 'action' => 'add']) ?>
                        <?= $this->Form->hidden('created_by_admin', ['value' => 1]) ?>
                        ...
                        <div class="form-row mt-2 col-md-12 clearfix">
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->input('codec', array('label' => 'Codec','options'=>$codecs, 'class' => 'form-control', 'required' => false, 'placeholder' => 'Prefix')); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-row mt-2 col-md-12 clearfix">
                            ...
                            <div class="col-md-6 mb-3">
                                <?= $this->Form->input('password', array('label' => 'Password', 'class' => 'form-control', 'type' => 'text', 'required' => true, 'placeholder' => 'Password')); ?>
                            </div>
                        </div>
