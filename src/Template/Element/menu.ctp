<nav class="navbar navbar-expand-sm navbar-default">
    <div id="main-menu" class="main-menu collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="<?php echo ($this->params['controller'] == 'campaigns')? "active":""?> menu-item-has-children dropdown">
            ...
            <li class="<?php echo ($this->params['controller'] == 'clients')? "active":""?> menu-item-has-children dropdown">
                ...
                <li class="<?php echo ($this->params['controller'] == 'iptsps')? "active":""?> menu-item-has-children dropdown">
           ...
           <?php } ?>
            ...
            <li class="<?php echo ($this->params['controller'] == 'contacts')? "active":""?> menu-item-has-children dropdown">
            ...
            <li class="<?php echo ($this->params['controller'] == 'contactGroups')? "active":""?> menu-item-has-children dropdown">
            ...
            <li class="<?php echo ($this->params['controller'] == 'gateways')? "active":""?> menu-item-has-children dropdown">
            ...
            <?php /*} */?>
            <?php if ($client['Client']['user_type_id']==3){?>
            <li class="<?php echo ($this->params['controller'] == 'callbackHistories')? "active":""?>">
                <?php echo $this->Html->link('<i class="menu-icon fa fa-volume-control-phone"></i>'.__(' Call Back'), array('controller' => 'callbackHistories', 'action' => 'index'), array('escape' => false)); ?>
            </li>
            <?php } ?>
